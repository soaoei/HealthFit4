...
public class Update_Register extends Activity {
		...
		oneButton.setPositiveButton("OK",
				new DialogInterface.OnClickListener() {
					...
					public void onClick(DialogInterface dialog, int which) {
						...
						nameDatabase.UpdateData(dataRegister[0], user.getText().toString(), pass.getText().toString(), name.getText().toString()

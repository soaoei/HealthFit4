package app.HealthFit.fileconfixe;
...
public class DatabaseExsersie extends SQLiteOpenHelper {
	
    // Database Version
    private static final int DATABASE_VERSION = 1;
 
    // Database Name
    private static final String DATABASE_NAME = "exsersietest";
 
    // Table Name
    private static final String TABLE_NAME = "exsersietabletest";

	public DatabaseExsersie(Context context) {
